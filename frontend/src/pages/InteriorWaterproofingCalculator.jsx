...
const InteriorWaterproofingCalculator = () => {
  ...
  // Automatic tiered pricing based on linear feet - INTERIOR RATES
  const getCostPerFoot = (feet) => {
    if (feet > 130) return 200;
    if (feet >= 51) return 250;
    return 300;
  };
...
INTERIOR WATERPROOFING CALCULATOR ESTIMATE REQUEST

Foundation Perimeter: ${linearFeet} linear feet
Cost Per Foot: $${costPerFoot}/ft (${linearFeet > 130 ? 'Volume discount' : linearFeet >= 51 ? 'Standard rate' : 'Small project rate'})
Base Interior Waterproofing Cost: $${baseCalc.toLocaleString()}
...
City: ${formData.city}
      ...
      const response = await fetch(`${backendUrl}/api/contact`, {
        ...
        body: JSON.stringify({
          ...
          address: formData.address,
          city: formData.city,
          subject: `Interior Waterproofing Calculator Quote - $${grandTotal.toLocaleString()} Estimate`,
  ...
  const structuredData = {
    ...
    "name": "Interior Waterproofing Cost Calculator",
  ...
  return (
    <div className="min-h-screen pt-24">
      <SEO
        title="Instant Interior Waterproofing Estimate Calculator | Groundhogs"
        description="Calculate your interior waterproofing cost instantly. Get accurate estimates based on foundation perimeter and optional sump pump installation."
        keywords="interior waterproofing cost calculator, interior basement waterproofing estimate, drainage system cost"
            ...
            <Card className="shadow-xl">
              <CardHeader className="text-center border-b bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-t-lg">
                <CardTitle className="text-3xl md:text-4xl mb-2">
                  Instant Interior Waterproofing Estimate
                </CardTitle>
                  ...
                  <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">
                      ...
                      <span className="text-blue-600 ml-2">
                        ...
                        {linearFeet >= 51 && linearFeet <= 130 && '(Standard rate)'}
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 rounded-xl p-6 mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-gray-700">
                      <span>Interior Waterproofing ({linearFeet} ft × ${costPerFoot}/ft)</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-lg border border-orange-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Cost-Effective Interior Solutions</h4>
                          <p className="text-sm text-gray-700">When exterior work isn't feasible, our interior systems keep basements dry year-round.</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default InteriorWaterproofingCalculator;
