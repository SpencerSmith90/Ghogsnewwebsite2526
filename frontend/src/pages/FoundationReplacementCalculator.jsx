                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-lg border border-orange-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Engineering & Permitting Handled</h4>
                          <p className="text-sm text-gray-700">We manage all engineering reports and municipal permits—taking the stress out of major foundation work.</p>
                        </div>
                      </div>
                    </div>
                  </div>
