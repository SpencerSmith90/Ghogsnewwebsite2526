        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="rounded-lg overflow-hidden shadow-xl">
              <img
                src="https://customer-assets.emergentagent.com/job_groundhogs-seo/artifacts/58s62gnr_unnamed.jpg"
                alt="Professional exterior waterproofing installation showing foundation membrane and drainage system"
                loading="lazy"
